    ...
    return (
        <>
            <section className="text-white body-font relative">
                <div className="w-full h-full md:w-10/12 mx-auto flex px-5 md:px-16 pt-12 md:flex-row flex-col items-center herosection">
