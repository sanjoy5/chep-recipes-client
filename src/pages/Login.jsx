        ...
        <>
            <div class="container px-5 py-20 mx-auto">
                <form class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0 border">
                    <h2 class="text-gray-900 text-2xl mb-3 font-medium title-font text-center">Login Here</h2>
                    ...
                    <button class="mt-2 text-white bgc-primary border-0 py-2 px-6 focus:outline-none hover:bg-orange-400 rounded text-lg">Login</button>
                    <p class="text-base text-gray-500 mt-3 text-center">Dont’t Have An Account ? <Link to="/register" className="text-red-500 px-0">Register</Link></p>
                </form>
